...
export class PaymentsService {
   ...
   */
  private async upsertPayment(orderId: string, data: Prisma.PaymentUncheckedUpdateInput): Promise<void> {
    ...
    await prisma.payment.create({
      data: { orderId, amount: 0, status: PaymentStatus.PENDING, ...data } as Prisma.PaymentUncheckedCreateInput,
    });
  }
}
